        ...
        for (int i=0;i<nrow;i++) {
            for (int j=0;j<ncol;j++ ) {
                if (GenericPoint2D<T>(i,j)==exit) {
                    cout << console::bg_white << console::fg_red << "X";
                    cout << console::bg_black << console::fg_white;
                ...
                if (!printed) {
                    if (isWalled(GenericPoint2D<T>(i,j))) cout << console::fg_white << "1";
                    else cout << console::fg_gray << "0";
                }
            }
            cout << "\n";
        }
