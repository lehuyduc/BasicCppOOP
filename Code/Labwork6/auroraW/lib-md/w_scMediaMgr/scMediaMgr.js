...
var scMediaMgr = {
	...
	fStrings: ["Show sub-titles", "Hide sub-titles",
	/*02*/      "Choose language", "Off",
	/*04*/      "Right click, save as... to download", "Play",
	/*06*/      "Mute", "Mute",
	/*08*/      "Transcript", "See transcript",
	/*10*/      "Video alternative", "View alternative video (LSF, LPC)",
	/*12*/      "Audiodescription", "View audiodescription",
	/*14*/      "Video", "View the original media",
	/*16*/      "Sub-titles", "View sub-titles",
	/*18*/      "Pause", "Play",
	/*20*/      "Activate sound", "Mute",
	/*22*/      "Hide transcript", "See transcript",
	/*24*/      "View in full-screen", "Press ESC to return to normal mode.",
	/*26*/      "Press ESC to quit full screen mode.", "",
	/*28*/      "Navigation bar", "Volume bar",
	/*30*/      "Download transcript", "Loading",
	/*32*/		"Unknown link type. Please, click on the link below to open it.", "High",
	/*34*/		"Medium", "Low",
	/*36*/		"Quality", "Quality",
	/*38*/		"Connection error. Please make sure you are connected to the internet.", ""],
